...
<head>
    <meta charset="utf-8" />
    <title>Page de negociations du syndicat "Les Tanners"</title>
    <link rel="Stylesheet" href="css/index.css" />
    <meta name="description" content="Site syndicale sur le developpement des negociations" />
...
<body>
    ...
    <div class="container">
        ...
        <div class="row" style="border-top:2px solid black;">
            <div class="col-12">
                <h2 style="text-align: center"> Prochaines manifestations</h2>
                <table>
                    <!-- <caption>Liste des syndicats</caption> -->
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td data-label="Ville">Montreal</td>
                            <td data-label="Adresse">Boulevard Mont-Seigneur, H71 7T8</td>
                            <td data-label="Date">03-05-2019 | 13:00</td>
                        </tr>
                        <tr>
                            <td data-label="Ville">Montreal</td>
                            <td data-label="Adresse">Boulevard Mont-Seigneur, H71 7T8</td>
        ...
        <div class="row">
            <div class="col-6">
                <div class="leftbox">
                    <a href="index.html"><img class="logo" src="img/logo.png" alt="Logo de compagnie, une spirale mauve" /></a>
                    <h2> Évolution des négociations </h2>
                    <p>
                        Les negociations "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi
                        <p>
                </div>
            </div>
        </div>
